...
def func(config_path, file, clock_region, site_dict, clock_region_path, pbar_2):
    ...
    for idx, cut in enumerate(CUTs):
        ...
        # fill cells
        configuration.fill_cells(site_dict, cut, idx)

        # VHDL instantiation
        g_buffer = Net.get_g_buffer(cut.G)
        VHDL_codes = tmpl.get_instantiation(idx, 'i_Clk_Launch', 'i_Clk_Sample', 'i_CE', 'i_CLR', w_Error_Mux_In,
                                            g_buffer)
